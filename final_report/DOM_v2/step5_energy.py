"""
energy.py — Scalar irradiance and energy balance for DOM_v2.

Public API
----------
scalar_irradiance(I0_dir, I0, IC, mu, w_mu, w_phi, N, M, K) -> ndarray (K,)
    Scalar irradiance at cell centres (no cosine weight).

energy_balance(I0_dir, I0, IC, Fd_dir, Fd_dif, Fu_unc, Fd_col, Fu_col,
               mu, w_mu, w_phi, N, M, K, G, dL, omega_L, rho_g, F_in)
    -> dict
    Compute and print the full energy balance table.
"""
...
def energy_balance(I0_dir, I0, IC,
    ...
    NOTE: The balance uses (1-rho_g)*F_trans, not F_trans itself.
    The ground-reflected portion rho_g*F_trans already flows back
    through the canopy and is counted in F_ref and A_leaves.
